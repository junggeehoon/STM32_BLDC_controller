...
/* Private defines -----------------------------------------------------------*/
#define DRIVE_EN3_Pin GPIO_PIN_14
#define DRIVE_EN3_GPIO_Port GPIOC
#define FAULT_Pin GPIO_PIN_12
#define FAULT_GPIO_Port GPIOB
#define INL1_EN1_Pin GPIO_PIN_13
#define INL1_EN1_GPIO_Port GPIOB
#define INL2_EN2_Pin GPIO_PIN_14
